...
### Applet Usage
The **staarpipelinesummary_varset** app can summarize the single variant or aggregate test results generated from the <a href="https://github.com/li-lab-genetics/staarpipeline-rap">**staarpipeline**</a> app, and will
...
```commandline
dx run staarpipelinesummary_varset <options>
```
